...
<body>
	...
	<form action="simpleJoin" method="POST">
	<div>
	<ul>
	...
	<div>주소</div>
	    ...
	    <input type="submit" id="joinChk" value="주문하기" class="join_button">
	   </form> 
	    <script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
	    
	    <script type="text/javascript">
	    $(document).ready(function() {
	    	var parent_val = opener.$('#productNumber').val();
	    	$('#productNumber').val(parent_val);
